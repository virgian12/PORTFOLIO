...
const Navbar = () => {
  ...
  return (
    <div>
        ...
        <div className='bg-black text-gray-400 h-[100px] w-full px-8 flex justify-between items-center'>
            

            <h1 className='text-3xl font-bold primary-color ml-4'>Virgianita Ramadhani Susilo Putri</h1>
